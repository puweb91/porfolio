  ...
  IpInput.prototype = {
    _init: function() {
      for (var i = 0; i < this.el.length; i++) {
        if (this.el.eq(i).hasClass('disabled')) {
          this.el.eq(i).html(
              '<div class="ip-input-container">' +
              '<input type="text" class="ip-input-item" value="' + (this.ipArr ? this.ipArr[0] : '') + '" disabled/>' +
              '<i class="ip-input-dot"></i>' +
              '<input type="text" class="ip-input-item" value="' + (this.ipArr ? this.ipArr[1] : '') + '" disabled/>' +
              '<i class="ip-input-dot"></i>' +
              '<input type="text" class="ip-input-item" value="' + (this.ipArr ? this.ipArr[2] : '') + '" disabled/>' +
              '<i class="ip-input-dot"></i>' +
              '<input type="text" class="ip-input-item" value="' + (this.ipArr ? this.ipArr[3] : '') + '" disabled/>' +
              '</div>'
          );
        } else {
          this.el.eq(i).html(
